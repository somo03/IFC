...
class Videos:
    ...
    def __init__(self, num_frames, video_length, num_classes, image_size, device):
        ...
        self.saved_cls    = torch.zeros((video_length, num_max_inst, num_classes+1), dtype=torch.float, device=device)
    ...
    def get_result(self, image_size):
        ...
        _mask_logits = retry_if_cuda_oom(interpolate)(
            _mask_logits, size=image_size, mode="bilinear", align_corners=False
        )
